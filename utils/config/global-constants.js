...
export const WF_INFO_LAST_UPDATE_SUCCESSFUL = "watchdrip_info_last_sucessful";

// force to use watchdrip-mini
export const WATCHDRIP_APP_ID = "38962";
export const WATCHDRIP_WF_ID = "38963";
